...
import {EmoticonNode} from './emoticon-plugin/EmoticonNode';
import {registerEmoticon} from './emoticon-plugin/EmoticonPlugin';
...
const initialConfig = {
  ...
  nodes: [HeadingNode, QuoteNode, EmoticonNode],
  onError: (error: Error) => {
    throw error;
  },
  theme: {
